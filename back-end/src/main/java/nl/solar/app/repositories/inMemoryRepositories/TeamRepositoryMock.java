...
////        teams = new ArrayList<>();
////        currentId = 1;
////        teams.add(new Team(currentId++, "Team 1", Team.WarehouseNames.SolarSedum, Team.TeamType.Internal));
////        teams.add(new Team(currentId++, "Team 2", Team.WarehouseNames.Superzon, Team.TeamType.External));
////        teams.add(new Team(currentId++, "Team 3", Team.WarehouseNames.Theswitch, Team.TeamType.External));
////        teams.add(new Team(currentId++, "Team 4", Team.WarehouseNames.Induct, Team.TeamType.External));
